...
export default function Contact({pageInfo}:Props) {
  ...
  return (
    <>
    {pageInfo.map((info)=>(
      <div className="h-screen relative flex flex-col text-center  md:text-left md:flex-row w-full sm:max-w-7xl px-10 justify-evenly mx-auto items-center mb-12" key={info._id}>
      <h3 className="absolute top-24 tracking-[20px] uppercase text-gray-500 sm:text-2xl text-xl invisible sm:visible">
        Contact
      </h3>
      <div className="flex flex-col space-y-10">
        <h4 className="text-4xl  font-semibold text-center md:mt-32 mt-10">
