...
export default function Contact() {
  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    window.open(`mailto:mustaksk62913@gmail.com?subject=${data.subject}&body=Hi, my name is ${data.name}. ${data.message} (${data.email})`);
  }
  return (
      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="md:text-2xl sm:text-xl">+91 6296917453</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="md:text-2xl sm:text-xl">mustaksk62913@gmail.com</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="md:text-2xl sm:text-xl">
              Bhakuri,Berhampore,Murshidabad,West Bengal,India
            </p>
          </div>
        </div>
        <form
